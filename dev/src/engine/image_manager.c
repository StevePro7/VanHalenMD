...
void engine_image_manager_draw( Image image, unsigned char palette, unsigned char x, unsigned char y )
{
	unsigned short *data = NULL;
	...
	VDP_drawImageEx( BG_A, &image, TILE_ATTR_FULL( palette, 0, 0, 0, 1 ), x, y, 0, CPU );
}
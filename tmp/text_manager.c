...
void engine_text_manager_draw_data_palette( unsigned short value, unsigned short x, unsigned short y )
{
	engine_sprite_manager_palette();
	VDP_setTextPalette( PAL3 );
	engine_font_manager_data( value, x, y );
	VDP_setTextPalette( PAL0 );
}
void engine_text_manager_draw_text_palette( const char *str, unsigned short x, unsigned short y )
{
	engine_sprite_manager_palette();
	VDP_setTextPalette( PAL3 );
